...
export const testimonials = [
  {
    id: "1",
    quote:
      "Ayush has a rare gift for finding the frame that says everything. The campaign images were more cinematic than we imagined possible.",
    author: "Priya Nair",
  ...
  },
  {
    id: "2",
    quote:
      "Working with him felt collaborative in the best way — he understood the brand's soul before he ever picked up the camera.",
    author: "Rohan Mehta",
  ...
  },
  {
    id: "3",
    quote:
      "The landscapes he delivered for our editorial spread became the most-shared images we've ever published.",
...
export const processSteps = [
  {
    num: "01",
    title: "Discovery",
    body: "A focused brief — your vision, references, timeline, and the feeling you want the images to carry.",
  },
  {
    num: "02",
    title: "Concept",
    body: "Moodboard, location scouting, and a shot-list shaped around light conditions and narrative arc.",
  },
  {
    num: "03",
    title: "Capture",
    body: "On-site execution with minimal crew and maximum intention. Every frame is considered, not collected.",
  },
  {
    num: "04",
    title: "Deliver",
    body: "Carefully retouched selects in your gallery within five business days. Print-ready on request.",
  },
];
